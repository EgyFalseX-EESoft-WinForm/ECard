...
{
    public partial class XRepCard3 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public XRepCard3(System.Data.DataTable TBL)
        {
            InitializeComponent();
            ...
            if (dsQry1.TblControl.Rows.Count != 0)
            {
                ...
                txt6.Visible = row.ctr1; 
                lbl7.Visible = row.ctr2; txt7.Visible = row.ctr2;
                lbl8.Visible = row.ctr3; txt8.Visible = row.ctr3;
                lbl9.Visible = row.ctr4; txt9.Visible = row.ctr4;
                lbl10.Visible = row.ctr5; txt10.Visible = row.ctr5;
                lbl11.Visible = row.ctr6; txt11.Visible = row.ctr6;
            }
